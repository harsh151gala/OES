...
if(date("d-m-Y H:i:s") is between $starttime and $endtime) {
 ...
 -->
          ...
          <?php
            ...
            $res=mysqli_query($link,"select * from questions where category ='DBMS'");

            while($row=mysqli_fetch_array($res))
            {
                ?>
            <input type="button" class="btn btn-success form-control" value="<?php echo $row["question_no"]; ?>" style="margin-top: 10px; background-color:#dee3de; color: black ;font-size:20px; font-weight:bold;">
                <?php
