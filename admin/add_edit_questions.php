        ...
        <div class="col-sm-4">
            <div class="page-header float-left">
                <div class="page-title">
                    <h1><font color="White">Add Question inside </font><?php echo "<font color='White'>" . $exam_category . "</font>"; ?></h1>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                                ...
                                <form name="form1" action="" method="post" enctype="multipart/form-data">
                                    <div class="card">
                                        <div class="card-header"><strong>
                                            <font color="White">Add New Questions with text</font></strong>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header"><strong><font color="White">Add New Questions with images</font></strong>
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <div class="form-group"><label for="company"
                                                           ...
                                                           style="padding-bottom:45px" required>
                                        </div>
